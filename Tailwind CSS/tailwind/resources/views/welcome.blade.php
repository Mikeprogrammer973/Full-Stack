...
<body>
    ...
    <hr>
    <div style="background-image: url('https://i.ytimg.com/vi/I1Di8bItp0s/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLDdtMdzswg6HxqggH_JPA0t6ES8Sg')" class="bg-gradient-to-r from-purple-600 via-blue-700 to-orange-500 mb-10 p-10 text-center bg-center bg-clip-text text-[3rem] font-extrabold text-transparent">Hello, World!</div>
</body>
</html>